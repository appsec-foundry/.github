...
- [appsec-advisor-tools](https://github.com/appsec-foundry/appsec-advisor-tools) — Companion scripts for running appsec-advisor threat modeling from a terminal, cron job, or CI pipeline, with repository profiling and templates for GitHub Actions and GitLab CI.
...
- [tss-web](https://github.com/appsec-foundry/tss-web) — An open security requirements framework covering technical and organizational controls for developing and operating web applications and services. **Discontinued:** The content is no longer maintained or further developed.
